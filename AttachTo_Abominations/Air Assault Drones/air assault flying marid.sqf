...
uavteam = creategroup east;

marshal03 = 'O_APC_Wheeled_02_rcws_F' createvehicle (screenToWorld [0.5,0.5]);
uav03 = createVehicle ['O_UAV_02_F', (screenToWorld [0.5,0.5]), [], 0, 'FLY'];
...
[_crewman] joinSilent creategroup [east, true];
