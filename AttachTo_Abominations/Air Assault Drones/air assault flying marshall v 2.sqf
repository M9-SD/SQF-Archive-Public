...
uav03 =  'O_UAV_02_F' createvehicle (screenToWorld [0.5,0.5]);
...
{
[uav03,[_i,"#(argb,8,8,3)color(0,0,0,1)"]] remoteExec ["setObjectTextureGlobal",0,uav03];
[marshal03,[_i,"#(argb,8,8,3)color(0,0,0,1)"]] remoteExec ["setObjectTextureGlobal",0,marshal03];
